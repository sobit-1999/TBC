...
export default function ProminentAppBar() {
  ...
  const [category1, setCategory1] = React.useState(false);
  const [category2, setCategory2] = React.useState(false);
      ...
      category: [
        ...
        },
        {
          ...
          section: [
            ...
            {
              nameSection: "TBC Visa Virtual kartasi",
              to: "/yordam_visa_karta",
            },
            {
              nameSection: `TBC UZ pul o'tkazmalar `,
              to: `/yordam_pul_o'tkazmalar`,
            },
            {
              nameSection: "TBC Virtual kartasi",
              to: "/yordam_virtual_kartasi",
            },
            {
              nameSection: `Muddatli TBC depozit`,
              to: `/yordam_muddatli_depozit`,
            },
  ...
  return (
    <>
      <Box sx={{ flexGrow: 1 }}>
        <AppBar
          position="static"
          sx={{ padding: "0 2%", backgroundColor: "#fff" }}
        >
          <StyledToolbar className="header_container">
            <Typography sx={{ flexGrow: 1, alignSelf: "flex"  }}>
            ...
            <Box className="category">
              ...
              <Typography>Helloblog</Typography>
            </Box>
            <Box className="icons">
              <Select
                sx={{
      ...
      {categoryHeader.map((item, i) => {
        return <HeaderCategory key={i} 
        data={item} 
        index={i}
        category1={category1}
        category2={category2}
